...
/**
 * Servlet implementation class UserPrenotazioni
 */
@WebServlet("/common/Prenotazioni")
public class UserPrenotazioni extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("/common/areaRiservata.jsp?edit=prenotazioni");
